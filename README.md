...
_Last updated: 2026-09-10 07:32 UTC_

_Tracking **18** upstream repos, **374** relevant open issues._
...
| ★★☆☆☆ | [#912](https://github.com/GoogleCloudPlatform/opentelemetry-operations-go/issues/912) Dependency Dashboard | priority: p3, dependencies | 0 | 2026-09-10 |
...
| Score | Issue | Labels | Comments | Updated |
|---|---|---|---|---|
| ★★☆☆☆ | [#414](https://github.com/grafana/google-bigquery-datasource/issues/414) Dependency Dashboard | — | 0 | 2026-09-10 |
...
| ★★★☆☆ | [#4069](https://github.com/traceloop/openllmetry/issues/4069) 🚀 Feature: Suggestion: Add beginner-friendly example for LLM tracing | good first issue | 11 | 2026-09-06 |
...
_Last run: 2026-09-10 07:31 UTC, took **82.0s**, **114** GitHub API calls, **4886/5000** rate limit remaining._
