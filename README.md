...
_Last updated: 2026-08-26 05:55 UTC_
...
| Score | Issue | Labels | Comments | Updated |
|---|---|---|---|---|
| ★★★★☆ | [#19520](https://github.com/prometheus/prometheus/issues/19520) Native histograms: update mixin to support NHCB | priority/Pmaybe, good first issue | 1 | 2026-08-26 |
...
_Last run: 2026-08-26 05:53 UTC, took **77.9s**, **114** GitHub API calls, **4886/5000** rate limit remaining._
