...
_Last updated: 2026-07-28 22:06 UTC_
...
| ★★☆☆☆ | [#912](https://github.com/GoogleCloudPlatform/opentelemetry-operations-go/issues/912) Dependency Dashboard | priority: p3, dependencies | 0 | 2026-07-28 |
...
| Score | Issue | Labels | Comments | Updated |
|---|---|---|---|---|
| ★★☆☆☆ | [#87308](https://github.com/ansible/ansible/issues/87308) Using `run_once: true` on a block will fail all hosts, but `rescue:` will only rescue the one host | needs_triage, bug, affects_2.21 | 1 | 2026-07-28 |
...
_Last run: 2026-07-28 22:05 UTC, took **55.6s**, **108** GitHub API calls, **4893/5000** rate limit remaining._
