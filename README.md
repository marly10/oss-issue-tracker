...
_Last updated: 2026-08-21 04:03 UTC_
...
| ★★☆☆☆ | [#912](https://github.com/GoogleCloudPlatform/opentelemetry-operations-go/issues/912) Dependency Dashboard | priority: p3, dependencies | 0 | 2026-08-21 |
...
| ★☆☆☆☆ | [#85605](https://github.com/ansible/ansible/issues/85605) Ansible 2.19.0 breaks  `loop`-templates because of jinja native types. | bug | 27 | 2026-08-20 |
...
| Score | Issue | Labels | Comments | Updated |
|---|---|---|---|---|
| ★★★☆☆ | [#109717](https://github.com/kubernetes/kubernetes/issues/109717) tracker: improve the kubelet test coverage | sig/node, help wanted, good first issue, needs-triage | 53 | 2026-08-19 |
...
| ★★★★☆ | [#50361](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/50361) exporter/faro: missing X-Faro-Session-Id header causes all exports to Grafana Cloud to fail with HTTP 400 | documentation, good first issue, exporter/faro | 6 | 2026-08-20 |
...
_Last run: 2026-08-21 04:02 UTC, took **78.9s**, **110** GitHub API calls, **4780/5000** rate limit remaining._
