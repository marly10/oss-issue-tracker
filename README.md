...
_Last updated: 2026-08-18 17:04 UTC_
...
| Score | Issue | Labels | Comments | Updated |
|---|---|---|---|---|
| ★★★★★ | [#50330](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/50330) Support component status attributes | enhancement, good first issue, extension/opamp | 1 | 2026-08-18 |
...
_Last run: 2026-08-18 17:03 UTC, took **61.0s**, **110** GitHub API calls, **4780/5000** rate limit remaining._
